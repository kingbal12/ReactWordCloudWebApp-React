...
const calendarDB = {
	events: [
		...
		{
			id: 14,
			title: '09:30 Jane Jang',
			allDay: false,
			start: setDate(2020, 10, 11, 9, 30, 0),
			end: setDate(2020, 10, 11, 9, 30, 0)
		},
		{
			id: 15,
			title: '10:30 Robin Choi',
			allDay: false,
			start: setDate(2020, 10, 11, 10, 30, 0),
			end: setDate(2020, 10, 11, 10, 30, 0)
		},
		{
			id: 16,
			title: '13:30 Davie',
			allDay: false,
			start: setDate(2020, 10, 18, 13, 30, 0),
			end: setDate(2020, 10, 18, 13, 30, 0)
		},
		{
			id: 17,
			title: '14:30 Lily',
			allDay: false,
			start: setDate(2020, 10, 18, 14, 30, 0),
			end: setDate(2020, 10, 18, 14, 30, 0)
		},
		{
			id: 18,
			title: '15:00 Kelly',
			allDay: false,
			start: setDate(2020, 10, 18, 15, 0, 0),
			end: setDate(2020, 10, 18, 15, 0, 0)
		},
		{
			id: 19,
			title: '16:00 Susan',
			allDay: false,
			start: setDate(2020, 10, 18, 16, 0, 0),
			end: setDate(2020, 10, 18, 16, 0, 0)
		},
		{
			id: 20,
			title: '16:30 Andrew',
			allDay: false,
			start: setDate(2020, 10, 18, 16, 30, 0),
			end: setDate(2020, 10, 18, 16, 30, 0)
		},
		{
			id: 21,
			title: '17:00 Jason',
			allDay: false,
			start: setDate(2020, 10, 18, 17, 0, 0),
			end: setDate(2020, 10, 18, 17, 0, 0)
		}
